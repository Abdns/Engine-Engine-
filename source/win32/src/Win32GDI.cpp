...
{
	// Day 025: сохраняем aspect-ratio. Если окно "толще" буфера — pillarbox (чёрные
	// полосы слева/справа). Если "выше" — letterbox (сверху/снизу).
	int OffsetX = 0;
	int OffsetY = 0;
	...
	// Чёрные полосы по бокам (или сверху/снизу).
